...
const mainLinks: LinkItem[] = [
  ...
  },
  {
    ...
    title:
      "カリキュラム　時間割｜筑波大学情報学群　情報メディア創成学類／University of Tsukuba",
  },
];

const presentationLinks: LinkItem[] = [
  {
    ...
    references: [{ href: "docs/axies-kdb.pdf", title: "発表資料（PDF）" }],
  },
  {
...
const Index = () => {
  ...
  return (
    <main className={styles.main}>
      <h1>KdBもどき関連リンク</h1>
      {LinkCollection(mainLinks)}

      <h2>発表</h2>
      {LinkCollection(presentationLinks)}

      <h2>記事掲載など</h2>
      {LinkCollection(articleLinks)}
    </main>
  );
};
